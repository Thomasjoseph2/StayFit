...
import { useAddTrainerProfileImageMutation } from '../../slices/trainerApiSlice';


const ChangeImageModal = ({ isOpen, onClose ,setRefresher,trainerId}) => {
  const [selectedImage, setSelectedImage] = useState(null);
  const [addProfileImage]=useAddTrainerProfileImageMutation();
...
if(selectedImage){
    try {
        ...
        formData.append("trainerImage",selectedImage)
